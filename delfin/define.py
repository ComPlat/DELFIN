...
keyword:red_step_3=[]
addition:red_step_3=[]
keyword:initial_OCCUPIER=[]
addition:initial_OCCUPIER=[]
keyword:ox_step_1_OCCUPIER=[]
addition:ox_step_1_OCCUPIER=[]
keyword:ox_step_2_OCCUPIER=[]
addition:ox_step_2_OCCUPIER=[]
keyword:ox_step_3_OCCUPIER=[]
addition:ox_step_3_OCCUPIER=[]
keyword:red_step_1_OCCUPIER=[]
addition:red_step_1_OCCUPIER=[]
keyword:red_step_2_OCCUPIER=[]
addition:red_step_2_OCCUPIER=[]
keyword:red_step_3_OCCUPIER=[]
addition:red_step_3_OCCUPIER=[]
keyword:S0=[]
addition:S0=[]
keyword:S0_TDDFT=[]
addition:S0_TDDFT=[]
