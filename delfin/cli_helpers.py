...
def _build_parser() -> argparse.ArgumentParser:
    ...
    description = (
        ...
        "Notes on --purge:\n"
        "  • Deletes all files/folders in the workspace except CONTROL.txt and the referenced input file.\n"
    ...
    epilog = (
        ...
        "  delfin --purge\n"
        "      Delete everything in the working directory except CONTROL.txt and its input file.\n\n"
        "  delfin --recalc\n"
