...
from delfin.workflows.scheduling.pool import PoolJob, JobPriority
...
class _WorkflowManager:
    ...
    def _adjust_priorities_for_bottlenecks(self) -> None:
        ...
        try:
            from delfin.workflows.scheduling.priority import adjust_job_priorities
    ...
    def _check_exclusive_bottleneck_boost(self, job: WorkflowJob) -> Optional[int]:
        ...
        """
        try:
            from delfin.workflows.scheduling.priority import is_exclusive_bottleneck
