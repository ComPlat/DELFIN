    ...
    *offer_structures* is handed every structure a conversion produced, as
    ...
    def _install_gfn_frame_watcher():
        ...
        _emit_watcher_js(
            ...
            '\n'
            '       Three in the queue is the guard, and it needs no other:\n'
            '       while the picture keeps up with the arrivals the queue\n'
            '       cannot grow past a frame or two, and the moment the\n'
            '       arrivals outrun it -- a relaxation, a scan, a climb, a\n'
            '       burst of any kind -- the queue grows past three and the\n'
            '       rules below take it back.  A burst of thirty drawn at a\n'
            '       follow pace of a third of a second each would put the\n'
            '       picture ten seconds behind a calculation that took one. */\n'
